...
python3 ../gen_conf.py --ips replicas_inter.txt --iter 1 --prefix 'hotstuff.gen' --keygen ../../hotstuff-keygen --tls-keygen ../../hotstuff-tls-keygen --sb-users 100 --sb-prob-choose_mtx 0.95 --sb-skew-factor 0.01 --fairness-parameter 1.0 --block-size 400 --clinworker 1 --nworker 1 --repnworker 1 --repburst 1000 --cliburst 1000
